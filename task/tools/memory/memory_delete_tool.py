...
class DeleteMemoryTool(BaseTool):
    ...
    def description(self) -> str:
        ...
        return "Tool for deleting all long-term memories about the user. This permanently removes all stored memories from the system. Use with caution - this action cannot be undone."
