...
class SearchMemoryTool(BaseTool):
    ...
    def description(self) -> str:
        ...
        return "Search long-term memories about the user using semantic similarity. Use this to recall user preferences, personal information, goals, and context from previous conversations. Returns the most relevant memories based on the query."
    ...
    async def _execute(self, tool_call_params: ToolCallParams) -> str:
        ...
        results: list[MemoryData] = await self.memory_store.search_memories(
            api_key=tool_call_params.api_key, query=query, top_k=top_k
        )
